...
<button id="fetch_blob">fetch_blob</button>
<button id="StreamSaver">StreamSaver</button>
<button id="StreamSaver_packZip">StreamSaver_packZip</button><br>
选择盘符:&nbsp C盘<input type="radio" name="driveName" value="C:/"> &nbsp
H盘<input type="radio" name="driveName" value="H:/"><br>
当前路径: <div></div>
</body>
</html>
