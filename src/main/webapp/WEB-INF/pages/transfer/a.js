!function (t, e) {
    ...
    return function (t) {
        ...
        l._withStripped = !0;
        var d = {y: {t: "top", m: "marginTop", b: "bottom"}, x: {l: "left", m: "marginLeft", r: "right"}}, p = {
            ...
            methods: {
                deselect: function () {
                    ...
                    var e = this.dimensionsBeforeMove, i = this.parentWidth, n = this.parentHeight, o = this.gridX,
                        r = this.gridY, s = this.width, a = this.height, h = e.top - t.y, c = e.bottom + t.y,
                        u = e.left - t.x, l = e.right + t.x;
                    if (this.snapToGrid) {
                        var f = !0, d = !0, p = h - Math.floor(h / r) * r, m = n - c - Math.floor((n - c) / r) * r,
                            v = u - Math.floor(u / o) * o, g = i - l - Math.floor((i - l) / o) * o;
                    ...
                    var b = this.rectCorrectionByLimit({newLeft: u, newRight: l, newTop: h, newBottom: c});
                    ...
                    var e = this.currentStick, i = this.dimensionsBeforeMove, n = this.gridY, o = this.gridX,
                        r = this.snapToGrid, s = this.parentHeight, a = this.parentWidth, h = i.top, c = i.bottom,
                        u = i.left, l = i.right;
                    switch (e[0]) {
                        case "b":
                    ...
                    var f = this.rectCorrectionByLimit({newLeft: u, newRight: l, newTop: h, newBottom: c});
                    if (u = f.newLeft, l = f.newRight, h = f.newTop, c = f.newBottom, this.aspectRatio) {
                        var d = this.rectCorrectionByAspectRatio({newLeft: u, newRight: l, newTop: h, newBottom: c});
                    ...
                    var t = this.aspectFactor, e = this.width, i = this.height, n = this.bottom, o = this.top,
                        r = this.left, s = this.right, a = this.minh, h = this.minw,
                        c = this.parentLimitation ? 0 : null;
                    this.aspectRatio && (h / a > t ? a = h / t : h = t * a);
                    var u = {
                        left: {min: c, max: r + (e - h)},
                        right: {min: c, max: s + (e - h)},
                        top: {min: c, max: o + (i - a)},
                        bottom: {min: c, max: n + (i - a)}
                    };
                    if (this.aspectRatio) {
                        var l = {
                            left: {min: r - Math.min(o, n) * t * 2, max: r + (i - a) / 2 * t * 2},
                            right: {min: s - Math.min(o, n) * t * 2, max: s + (i - a) / 2 * t * 2},
                            top: {min: o - Math.min(r, s) / t * 2, max: o + (e - h) / 2 / t * 2},
                            bottom: {min: n - Math.min(r, s) / t * 2, max: n + (e - h) / 2 / t * 2}
                        };
                    ...
                    var e = t.newLeft, i = t.newRight, n = t.newTop, o = t.newBottom, r = this.parentWidth,
                        s = this.parentHeight, a = this.currentStick, h = this.aspectFactor,
                        c = this.dimensionsBeforeMove, u = r - e - i, l = s - n - o;
                    if ("m" === a[1]) {
                        var f = l - c.height;
                        e -= f * h / 2, i -= f * h / 2
                    } else if ("m" === a[0]) {
        ...
        }, m = p, v = (i(12), i(1)), g = Object(v.a)(m, l, f, !1, null, null, null);
        ...
        function o(t, e) {
            for (var i = [], n = {}, o = 0; o < t.length; o++) {
                var r = t[o], s = e.base ? r[0] + e.base : r[0], a = r[1], h = r[2], c = r[3],
                    u = {css: a, media: h, sourceMap: c};
                n[s] ? n[s].parts.push(u) : i.push(n[s] = {id: s, parts: [u]})
            }
            return i
        }
        ...
        function d(t, e, i) {
            var n = i.css, o = i.sourceMap, r = void 0 === e.convertToAbsoluteUrls && o;
            (e.convertToAbsoluteUrls || r) && (n = x(n)), o && (n += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");
            var s = new Blob([n], {type: "text/css"}), a = t.href;
